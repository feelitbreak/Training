...
namespace Blog.Pages
{
    ...
    {
        public readonly ImmutableList<BlogPost> Archive = ImmutableList.Create
    (
      ...
      new BlogPost("Mushroom Pork Chops", new DateTime(2019, 6, 14), "Quick and easy, but very delicious. One of my family's favorites served over brown rice.")
        ...
        public BlogPost Displayed { get; set; } = new BlogPost(string.Empty, DateTime.Today, string.Empty);
