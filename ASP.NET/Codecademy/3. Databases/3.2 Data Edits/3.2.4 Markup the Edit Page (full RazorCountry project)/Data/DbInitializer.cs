...
namespace RazorCountry.Data
{
    public static class DbInitializer
    {
        ...
        new Continent{ID="AN",Name="Antartica"},
            ...
            {
        new Country{ID="USA",Name="United States",ContinentID="NA",Population=330529481,Area=89,UnitedNationsDate=new DateTime(1945,10,24)},
        new Country{ID="BRA",Name="Brazil",ContinentID="SA",Population=210938214,UnitedNationsDate=new DateTime(1945,10,24)},
        new Country{ID="FRA",Name="France",ContinentID="EU",Population=67081000,Area=3,UnitedNationsDate=new DateTime(1945,10,24)},
        new Country{ID="CHN",Name="China",ContinentID="AS",Population=1400737880,Area=5,UnitedNationsDate=new DateTime(1945,10,24)},
