...
namespace Strings
{
    public static class UsingRanges
    {
        ...
        /// <summary>
        /// Gets a string without two first characters of the <paramref name="str"/> string.
        /// </summary>
        ...
        /// <summary>
        /// Gets a string without three first characters of the <paramref name="str"/> string.
        /// </summary>
