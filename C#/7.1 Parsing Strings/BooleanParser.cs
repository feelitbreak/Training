...
namespace ParsingStrings
{
    public static class BooleanParser
    {
        ...
        /// </summary>
        /// <param name="str">A string containing the value to convert.</param>
        /// <returns>true if value is equivalent to <see cref="bool.TrueString"/>; false if value is equivalent to <see cref="bool.FalseString"/>. If a formatting error occurs returns false.</returns>
