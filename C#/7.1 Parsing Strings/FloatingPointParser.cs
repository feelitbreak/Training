...
namespace ParsingStrings
{
    public static class FloatingPointParser
    {
        ...
        /// </summary>
        /// <param name="str">The string representation of the number to convert.</param>
        /// <returns>The equivalent to the number contained in <paramref name="str"/>. If a formatting error occurs returns -1.1 decimal value. If an overflow error occurs returns -2.2 decimal value.</returns>
